...
<footer>
	...
	<div id="pied">
		...
		<a href="#" onclick="showPopup(); return false;">MENTIONS LÉGALES | CONDITIONS GÉNÉRALES | CONTACT | VIE
			PRIVÉE</a>

		<div id="arc-de-cercle"></div>
	</div>
	...
	<div id="popup-overlay" class="popup-overlay" onclick="hidePopup();">
		<div class="popup" onclick="event.stopPropagation();">
			...
			<p>"Smiley" est édité par Marie&Martial Industries, une société enregistrée en France, sous le
			...
			<p>Le responsable de la publication du site "Les Recettes du Chef" est Marie&Martial, joignable à
				l'adresse 9 rue Tunis 62300 Lens ou par courriel à l'adresse smileyconcepteur@gmail.com.</p>

			<h2>3. Hébergement du site :</h2>
			<p>Le site "Smley" est hébergé par OVH, dont le siège social est situé à
				2 rue Kellermann - 59100 Roubaix - France.</p>

			<h1>Conditions générales</h1>
			<h2>1. Utilisation du site :</h2>
			<p>En accédant et en utilisant le site "Smiley", vous acceptez d'être lié par les présentes
			...
			<p>Adresse : 9 rue Tunis 62300 Lens<br>
				...
				E-mail : <a href="mailto: smileyconcepteur@gmail.com">smileyconcepteur@gmail.com.</a></p>

			<h1>Vie privée</h1>
			<h2>1. Collecte des données personnelles :</h2>
			<p>Nous pouvons collecter certaines données personnelles, telles que votre nom, votre adresse e-mail et
				votre adresse IP, lorsque vous utilisez le site. Ces informations seront traitées
			...
			<p>Les données personnelles collectées peuvent être utilisées pour vous fournir des informations, des
				services ou du contenu personnalisé liés au site "Smiley". Nous ne partagerons pas vos
